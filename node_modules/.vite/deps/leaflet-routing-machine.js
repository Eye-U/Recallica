...
(function() {
				...
				module.exports = Itinerary.extend({
					...
					_updateLines: function(routes) {
						...
						if (routes.alternatives) routes.alternatives.forEach(function(alt, i) {
							this._alternatives[i] = this.options.routeLine(alt, L.extend({ isAlternative: true }, this.options.altLineOptions || this.options.lineOptions));
		...
		(function(global) {
			(function() {
				...
				module.exports = L.Class.extend({
					...
					initialize: function(options) {
						L.setOptions(this, options);
						this._localization = new Localization(L.Util.isArray(this.options.language) ? this.options.language : [this.options.language, "en"]);
					},
					formatDistance: function(d, sensitivity) {
						var un = this.options.unitNames || this._localization.localize("units"), simpleRounding = sensitivity <= 0, round = simpleRounding ? function(v) {
							return v;
						} : L.bind(this._round, this), v, yards, data;
					...
					formatInstruction: function(instr, i) {
						if (instr.text === void 0) return this.capitalize(L.Util.template(this._getInstructionTemplate(instr, i), L.extend({}, instr, {
				...
				module.exports = L.Class.extend({
					...
					options: {
						createGeocoder: function(i, nWps, options) {
							var container = L.DomUtil.create("div", "leaflet-routing-geocoder"), input = L.DomUtil.create("input", "", container), remove = options.addWaypoints ? L.DomUtil.create("span", "leaflet-routing-remove-waypoint", container) : void 0;
			...
			(function() {
				...
				module.exports = L.Class.extend({
					...
					createContainer: function(className) {
						var table = L.DomUtil.create("table", (className || "") + " " + this.options.containerClassName), colgroup = L.DomUtil.create("colgroup", "", table);
					...
					createStep: function(text, distance, icon, steps) {
						var row = L.DomUtil.create("tr", "", steps), span, td = L.DomUtil.create("td", "", row);
			...
			(function() {
				...
				module.exports = L.Control.extend({
					...
					_selectAlt: function(e) {
						...
						if (L.DomUtil.hasClass(altElem, "leaflet-routing-alt-minimized")) for (j = 0; j < this._altElements.length; j++) {
	...
	59: [function(_dereq_, module, exports) {
		(function(global) {
			(function() {
				"use strict";
				var L = typeof window !== "undefined" ? window["L"] : typeof global !== "undefined" ? global["L"] : null, corslite = _dereq_("@mapbox/corslite"), polyline = _dereq_("@mapbox/polyline"), osrmTextInstructions = _dereq_("osrm-text-instructions")("v5");
				...
				*/
				module.exports = L.Class.extend({
					...
					_convertRoute: function(responseRoute) {
						...
						else stepToText = L.bind(osrmTextInstructions.compile, osrmTextInstructions, this.options.language);
			...
			(function() {
				...
				module.exports = (L.Layer || L.Class).extend({
					...
					_dragNewWaypoint: function(newWpIndex, initialLatLng) {
						...
						for (i = 0; i < this.options.dragStyles.length; i++) lines.push(L.polyline([
							prevWp.latLng,
							initialLatLng,
							nextWp.latLng
